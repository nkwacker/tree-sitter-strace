...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(123),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(27),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(15),
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(93),
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(120),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(22),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(15),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(79),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictElem, 2),
  [73] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_values_repeat1, 2),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_values_repeat1, 2),
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_values_repeat1, 2), SHIFT_REPEAT(85),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_values, 1),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_values, 1),
  ...
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_values, 2),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dict, 4),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dict, 4),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dict, 5),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dict, 5),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dict, 6),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dict, 6),
  ...
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dict, 3),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dict, 3),
  ...
  [146] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(145),
  [149] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(106),
  [152] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(92),
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(103),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(104),
  [161] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(4),
  [164] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(67),
  ...
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictFn, 3),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dictFn, 3),
  ...
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 3),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parameter, 2),
  [199] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 4),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parameter, 4),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 5),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parameter, 5),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 1),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_parameters_repeat1, 1),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parameters, 3),
  ...
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 1),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parameters, 1),
  [233] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_parameters_repeat1, 2),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 4),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parameters, 4),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 6),
  [243] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [245] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 6),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 5),
  [249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 5),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 4),
  [255] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 4),
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 2),
  [261] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [263] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 2),
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_killSignal, 5),
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_killSignal, 5),
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 8),
  [271] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 8),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attach, 3),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attach, 3),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 9),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 9),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exit, 5),
  [283] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_exit, 5),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 7),
  [287] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 7),
  [289] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [291] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_signal, 4),
  [293] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_signal, 4),
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pid, 1),
  [297] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pid, 1),
  [299] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  [301] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2), SHIFT_REPEAT(71),
  [304] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2), SHIFT_REPEAT(69),
  [307] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2),
  [309] = {.entry = {.count = 1, .reusable = false}}, SHIFT(90),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_returnValue, 1),
  ...
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_forkedPid, 3),
  [329] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_forkedPid, 3),
  ...
  [353] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_errorDescription_repeat1, 2), SHIFT_REPEAT(127),
  [356] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_errorDescription_repeat1, 2),
  [358] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_errorDescription_repeat1, 2), SHIFT_REPEAT(83),
  [361] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2),
  [363] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(88),
  [366] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(88),
  ...
  [385] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dict_repeat1, 2), SHIFT_REPEAT(78),
  [388] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dict_repeat1, 2),
  [390] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_errorDescription_repeat1, 2),
  [392] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_returnValue, 2),
  [394] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [396] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [398] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dictElem_repeat1, 2), SHIFT_REPEAT(114),
  [401] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dictElem_repeat1, 2),
  ...
  [417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictElem, 3),
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro, 4),
  [421] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_errorName, 1),
  [423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_errorName, 1),
  [425] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictElem, 4),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dictValue, 2),
  ...
  [451] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_errorDescription, 2),
  [453] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [455] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_returnValue, 3),
  ...
  [465] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_errorDescription, 3),
